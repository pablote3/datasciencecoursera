...
##Synopsis
Storm and severe weather event data between 1950 and 2011 was processed and transformed before breaking into separate 
data sets for harmful events and damage events.  These data sets were then grouped by events and summarized.
